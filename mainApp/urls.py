...
urlpatterns = [
    ...
    path(
        "privateTutor-rud/<int:pk>",
        PrivateTutorRUD.as_view(),
        name="privateTutor_list_rud",
    ),
    ...
    path(
        "contractedTutor-rud/<int:pk>",
        ContractedTutorRUD.as_view(),
        name="contractedTutor_list_rud",
    ),
    path(
        "privateTutor-post",
        ContractedTutorCreate.as_view(),
        name="contractedTutor_post",
    ),
    # unavailableSlot
    path("unavailableslot", UnavailableSlotlist.as_view(), name="unavailableslot_list"),
    path(
        "unavailableslot-rud/<int:pk>",
        UnavailableSlotRUD.as_view(),
        name="unavailableslot_list_rud",
    ),
    path(
        "unavailableslot-post",
        UnavailableSlotCreate.as_view(),
        name="unavailableslot_post",
    ),
    # transaction
    path("transaction", Transactionlist.as_view(), name="transaction_list"),
    path(
        "transaction-rud/<int:pk>",
        TransactionRUD.as_view(),
        name="transaction_list_rud",
    ),
